...
export default function MyProfileForm({ isCheckOutPage, handleOpenDrawer }: any) {
  ...
  return (
    <div className="w-full">
      {/* "border border-gray-300 rounded-lg p-8 bg-white w-full mx-auto shadow-sm" */}
      <div
        className={`${
          isCheckOutPage ? 'border-none' : 'border border-gray-300 shadow-sm'
        } rounded-lg p-8 bg-white w-full mx-auto `}
      >
        {/* Header */}
        {!isCheckOutPage && (
          <div className="mb-8">
