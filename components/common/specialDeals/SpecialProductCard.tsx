...
export default function SpecialProductCard({ specialProducts }: any) {
  ...
  return (
    <section className="wrapper py-12 m-auto poppins-font">
      <h2 className="text-center text-3xl font-semibold text-red-500 mb-12">Sale has ended!</h2>
          ...
          <div key={product.id} className="bg-white overflow-hidden rounded-t-xl">
            ...
            <div className="space-y-2 p-4">
              ...
              <div className="space-y-1">
                ...
                <p className="text-green-600 text-2xl font-extrabold">$ {product.special_price}</p>
                {isAuthenticated && (
                  <button
